...
SELECT persona.nombre, persona.apellido1, persona.apellido2 FROM profesor LEFT JOIN asignatura ON profesor.id_profesor = asignatura.id_profesor JOIN persona ON profesor.id_profesor = persona.id WHERE asignatura.id_profesor IS NULL ORDER BY persona.apellido1, persona.apellido2, persona.nombre;
